...
function setup() {
  ...
  //Creating the buttons for choosing the levels
...
function drawGame() {
  ...
  // once you press SPACE, it checks if the barrel is attached and inside the collection point
  //if the conditions are met, the barrel disappears.
...
//Function to reset the game variables when you restart the game.
function resetGame() {
  toxicBarrels = [];
  underwaterMines = [];
  submarine.x = 150;
...
//Function to resize the canvas if the window is resized.
